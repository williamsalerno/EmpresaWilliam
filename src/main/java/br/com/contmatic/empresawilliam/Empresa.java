...
public class Empresa {
	...
	/**
	 * Verifica se a data de alteração da empresa não é anterior à data de
	 * criação dela.
	 *
	 * @param dataDeAlteracao
	 *            the data de alteracao
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("Razão social: ", razaoSocial)
				.append("Proprietário: ", proprietario).append("CNPJ", cnpj)
				.append("Endereço: ", Arrays.toString(enderecos)).append("Telefone: ", Arrays.toString(telefones))
				.append("Email: ", email).append("Site: ", site)
				.append("Data de criação: ",
						(converteDataDeCriacao(dataDeCriacao) != null) ? converteDataDeCriacao(dataDeCriacao) : null)
				.append("Data de alteração: ", (converteDataDeAlteracao(dataDeAlteracao) != null)
						? converteDataDeAlteracao(dataDeAlteracao) : null)
				.build();
	}
